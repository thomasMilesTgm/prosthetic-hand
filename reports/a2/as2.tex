...
However, if rigidity is too low then the ability of the prothesis to effectively grip and manipulate objects would be affected.
        }
		\end{enumerate}
